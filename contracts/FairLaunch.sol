...
contract FairLaunch is Ownable {
    // Launch helpers
    IFactory factory = IFactory(0x33128a8fC17869897dcE68Ed026d694621f6FDfD); // UniswapFactoryV3
    INFPManager nfpManager =
    INFPManager(0x03a520b32C04BF3bEEf7BEb72E919cf822Ed34f1); // V3
    IRouter router = IRouter(0x2626664c2603336E57B271c5C0b26F421741e481);  // V3
